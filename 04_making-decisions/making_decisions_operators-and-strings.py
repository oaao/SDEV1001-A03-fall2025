...
# With method 2, we combine the addition (+) and assignment (=) operators to increase the value of "my_num"
...
# modulus, i.e. get the remainder only:
# 8 % 4 --> 0
# 9 % 4 --> 1
# 9 % 5 --> 4
my_num %= 2
...
### STRING METHODS ###
# Python has a lot of built in string functions that are super handy
# see more at:
# - python docs:  https://docs.python.org/3/library/stdtypes.html#string-methods
# - easy list:    https://www.w3schools.com/python/python_ref_string.asp


my_string = "   Hello Everyone!   "
print(my_string)

# upper() - makes the entire string upper case
