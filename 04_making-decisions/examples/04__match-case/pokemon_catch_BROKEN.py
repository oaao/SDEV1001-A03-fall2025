...
# (because you're a dirty minmaxer who chose to keep an unevolved lv99 Charmander for better stats).
#
# The code below is broken, and we'll have to figure out how to fix it.
#
# PREMISES:
#     1. Charizard has a catch threshold of 95, meaning a player must score at least 95 when they throw a ball to catch it.
#
#     2. There are four types of balls, and each add a bonus to the catch chance.
#        - Poke Ball, Bonus: 10
#        - Great Ball, Bonus: 30
#        - Ultra Ball, Bonus: 50
